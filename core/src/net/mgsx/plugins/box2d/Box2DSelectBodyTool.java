...
public class Box2DSelectBodyTool extends SelectToolBase
{
	private WorldItem worldItem;
	private Editor editor;
	
	public Box2DSelectBodyTool(Editor editor, WorldItem worldItem) {
		super(editor);
		this.editor = editor;
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) 
	{
		...
		else
		{
			...
			for(Entity entity : editor.entityEngine.getEntitiesFor(Family.one(Box2DBodyModel.class).get())){
