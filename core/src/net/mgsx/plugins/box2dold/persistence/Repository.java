package net.mgsx.plugins.box2dold.persistence;
...
import net.mgsx.plugins.box2dold.model.EditorSettings;
...
public class Repository 
{
	...
	public static void load(FileHandle file, WorldItem worldItem)
	{
		...
		for(BodyData bodyData : data.bodies){
			...
			Box2DBodyModel bodyItem = new Box2DBodyModel(null, bodyData.name, bodyData.def, body);
