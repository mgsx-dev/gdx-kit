...
import net.mgsx.plugins.box2dold.model.Items;
import net.mgsx.plugins.box2dold.model.JointItem;
...
public class Box2DPresets 
{
	...
	public static Box2DBodyModel ball(World world, float size, float x, float y) 
	{
	...
	public static final Box2DPreset pulley = new Box2DPreset(){
		...
		public void create(Items items, World world, float x, float y) {
			...
			Box2DBodyModel ballA = ball(world, 30f, x-50, y-25); // 30cm ball
			Box2DBodyModel ballB = ball(world, 30f, x+50, y-25); // 40cm ball
	...
	public static final Box2DPreset rope = new Box2DPreset() {
		...
		public void create(Items items, World world, float x, float y) 
		{
			Box2DBodyModel prev = null;
			for(int i=0 ; i<2 ; i++)
			{
				Box2DBodyModel cur = ball(world, 30f, x, y-i*40);
