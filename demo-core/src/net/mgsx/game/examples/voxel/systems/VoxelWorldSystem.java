package net.mgsx.game.examples.voxel.systems;
...
import net.mgsx.game.examples.voxel.utils.Cube;
import net.mgsx.game.examples.voxel.utils.Index3;
import net.mgsx.game.examples.voxel.utils.Noise;
import net.mgsx.game.examples.voxel.utils.OpenSimplexNoise;
...
//					size = 3;
	...
	public VoxelWorldSystem(GameScreen game) {
		...
		this.game = game;
		this.texture = new Texture("voxel/craft.png");
