...
@EditableSystem
public class GPUTesslatorSystem extends IteratingSystem
{
	public static interface GL4{
		public void prepareTesslation();
	};
	...
	private ShaderProgramEx shader;

	public GPUTesslatorSystem(EditorScreen screen) {
		super(Family.all(G3DModel.class, TesslationComponent.class).exclude(FoliageComponent.class).get(), GamePipeline.RENDER);
		this.screen = screen;
	}
	...
	public void loadShader()
	{
		...
		ShaderProgramEx shader = new ShaderProgramEx(
				Gdx.files.internal("gpu/tess-wire.vs"), 
				Gdx.files.internal("gpu/tess-wire.tcs"), 
				Gdx.files.internal("gpu/tess-wire.tes"), 
				Gdx.files.internal("gpu/tess-wire.gs"), 
				Gdx.files.internal("gpu/tess-wire.fs"));
	...
	protected void processEntity(Entity entity, float deltaTime) {
		...
		// pick.mesh.render(shader, GL20.GL_TRIANGLES);
...
//		shader.setUniformf("u_limit", limit);
