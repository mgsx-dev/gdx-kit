 ...
 * 
 * @author mzechner */
public class ShaderProgramEx extends ShaderProgram implements Disposable {
	...
	private final static ObjectMap<Application, Array<ShaderProgramEx>> shaders = new ObjectMap<Application, Array<ShaderProgramEx>>();
	...
	private String tcsSource;
	private String tesSource;
	private int tcsHandle;
	private int tesHandle;
	...
	public ShaderProgramEx (String vertexShader, String fragmentShader) {
		this(vertexShader, null, fragmentShader);
	}
	public ShaderProgramEx (String vertexShader, String geometryShader, String fragmentShader) {
		this(vertexShader, null, null, geometryShader, fragmentShader);
	}
	public ShaderProgramEx (String vertexShader, String tcs, String tes, String geometryShader, String fragmentShader) {
		super(vertexShader, fragmentShader); // XXX won't work ...
		...
		compileShaders(vertexShader, tcs, tes, geometryShader, fragmentShader);
		if (isCompiled()) {
			fetchAttributes();
			fetchUniforms();
	...
	public ShaderProgramEx (FileHandle vertexShader, FileHandle tcs, FileHandle tes, FileHandle geometryShader, FileHandle fragmentShader) {
		this(vertexShader.readString(), tcs == null ? null : tcs.readString(), tes.readString(), geometryShader.readString(), fragmentShader.readString());
	}
	public ShaderProgramEx (FileHandle vertexShader, FileHandle geometryShader, FileHandle fragmentShader) {
		this(vertexShader.readString(), geometryShader.readString(), fragmentShader.readString());
	}
	public ShaderProgramEx (FileHandle vertexShader, FileHandle fragmentShader) {
	...
	private void compileShaders (String vertexShader, String tcs, String tes, String geometryShader, String fragmentShader) {
		...
		if (vertexShaderHandle == -1 || fragmentShaderHandle == -1 || 
				(geometryShader != null && geometryShaderHandle == -1)|| 
				(tcs != null && tcsHandle == -1)|| 
...
// }
	...
	private void checkManaged () {
		if (invalidated) {
			compileShaders(vertexShaderSource, tcsSource, tesSource, geometryShaderSource, fragmentShaderSource);
			invalidated = false;
		}
	}

	private void addManagedShader (Application app, ShaderProgramEx shaderProgram) {
		Array<ShaderProgramEx> managedResources = shaders.get(app);
		if (managedResources == null) managedResources = new Array<ShaderProgramEx>();
	...
	public static void invalidateAllShaderPrograms (Application app) {
		...
		Array<ShaderProgramEx> shaderArray = shaders.get(app);
