...
import net.mgsx.game.examples.platformer.ai.PatrolDebugSystem;
...
@PluginDef(dependencies={PlatformerPlugin.class, PdEditorPlugin.class})
public class PlatformerEditorPlugin extends EditorPlugin implements DefaultEditorPlugin
{
	...
	public void initialize(EditorScreen editor) 
	{
		...
		editor.entityEngine.addSystem(new PatrolDebugSystem(editor));
	}
