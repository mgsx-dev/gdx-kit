package net.mgsx.game.examples.procedural.editors;
...
import net.mgsx.game.examples.procedural.model.Formula;
import net.mgsx.game.examples.procedural.model.FormulaParser;
import net.mgsx.game.examples.procedural.model.LSystem;
import net.mgsx.game.examples.procedural.model.Parameter;
import net.mgsx.game.examples.procedural.model.Rule;
import net.mgsx.game.examples.procedural.model.l2d.Rules2D;
...
public class LSystemEditor implements EntityEditorPlugin
{
	...
	private void create(Table root, Skin skin, LSystem3D lsystem, Parameter p) {
		root.add(p.name);
		root.add(new FloatWidget(new FieldAccessor(p, "value"), false, skin)).row();
	}
