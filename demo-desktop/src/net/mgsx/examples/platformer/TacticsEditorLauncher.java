...
import net.mgsx.game.examples.tactics.TacticsPlugin;
 ...
 *
 */
public class TacticsEditorLauncher {
	...
	public static void main (String[] args) 
	{
		ClassRegistry.instance = new ReflectionClassRegistry(
				...
				"net.mgsx.game.examples.tactics"
				);
		...
		editConfig.plugins.add(new TacticsPlugin());
