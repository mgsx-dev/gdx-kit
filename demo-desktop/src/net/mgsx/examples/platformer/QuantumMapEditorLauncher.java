...
import net.mgsx.game.examples.quantum.QuantumEditorPlugin;
 ...
 *
 */
public class QuantumMapEditorLauncher {
	...
	public static void main (String[] args) 
	{
		ClassRegistry.instance = new ReflectionClassRegistry(
				...
				"net.mgsx.game.examples.quantum"
				);
		...
		editConfig.plugins.add(new QuantumEditorPlugin());
