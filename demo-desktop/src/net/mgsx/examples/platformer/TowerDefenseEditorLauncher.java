 ...
 *
 */
public class TowerDefenseEditorLauncher {
	...
	public static void main (String[] args) 
	{
		ClassRegistry.instance = new ReflectionClassRegistry(
				...
				ReflectionClassRegistry.kitBehaviorTreePlugin,
				"net.mgsx.game.examples.td"
				);
		...
		editConfig.plugins.add(new TowerDefenseEditorPlugin());
